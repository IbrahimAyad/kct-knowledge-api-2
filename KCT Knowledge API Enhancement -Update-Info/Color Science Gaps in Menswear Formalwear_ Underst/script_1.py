# Create comprehensive analysis of color science gaps in menswear formalwear - Fixed version
import pandas as pd
import numpy as np
...
# Calculate overall accuracy for lighting
lighting_df['Overall_Accuracy'] = (lighting_df['Red_Accuracy_Score'] + 
                                 lighting_df['Blue_Accuracy_Score'] + 
                                 lighting_df['Green_Accuracy_Score']) / 3
...
top_lighting = lighting_df.nlargest(5, 'Overall_Accuracy')
